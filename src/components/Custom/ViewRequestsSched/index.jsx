...
class ViewRequestsSched extends React.Component {
  ...
  async componentDidMount() {
    let url = "https://vcm-17934.vm.duke.edu/api/getforms/integrator";
    let self = this;
    let result;
    await axios.get(url, 
  ...
  async handleApprove() {
    let url = "https://vcm-17934.vm.duke.edu/api/request/modify";
    let self = this;
    let vars = {
      id: self.state.id, 
    }
    ...
    url = "https://vcm-17934.vm.duke.edu/api/calendar-entry";
  ...
  async handleApproveChanges () {
    ...
    const url = "https://vcm-17934.vm.duke.edu/api/request/modify";
    let self = this;
    let vars = {
      id: self.state.id, 
