...
class AuthenticateUser extends React.Component {
  ...
  async componentDidMount() {
      var self = this;
      let url = 'https://vcm-17934.vm.duke.edu/api/user/authenticate-user';
      await axios.get(url, {
    ...
    async deleteAccount() {
      let self = this;
      let url = 'https://vcm-17934.vm.duke.edu/api/user/deleteuser';
    ...
    let urlGet = 'https://vcm-17934.vm.duke.edu/api/user/authenticate-user';
